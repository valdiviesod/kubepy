...
group_bp.route('/create', methods=['POST'])(create_group)
group_bp.route('/update/<int:group_id>', methods=['PUT'])(update_group)
group_bp.route('/delete/<int:group_id>', methods=['DELETE'])(delete_group)
